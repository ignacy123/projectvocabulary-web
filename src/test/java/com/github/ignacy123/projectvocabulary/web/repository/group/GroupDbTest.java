...
public class GroupDbTest extends BaseDBUnitTest {
    @Autowired
    GroupJdbcRepository repository;
    @Test
    @DatabaseSetup(value = "classpath:repository/group/GroupRepositoryDbTest_testSave_input.xml")
    @ExpectedDatabase(value = "classpath:repository/group/GroupRepositoryDbTest_testSave_output.xml",
